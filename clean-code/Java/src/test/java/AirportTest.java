...
public class AirportTest {
    ...
    private PassengerPlane expectedPlaneWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);

    @Test
    public void testGetTransportMilitaryPlanes() {
        List<MilitaryPlane> transportMilitaryPlanes = airport.getTransportMilitaryPlanes();
        Assert.assertTrue(hasPlanesWithOnlyOneMilitaryType(transportMilitaryPlanes, MilitaryType.TRANSPORT));
    }
    ...
    public void testSortByMaxLoadCapacity() {
        ...
        Assert.assertTrue(hasCorrectSortByMaxLoadCapacity(planesSortedByMaxLoadCapacity));
    }

    @Test
    public void testGetBomberInMilitaryPlanes() {
        List<MilitaryPlane> bomberMilitaryPlanes = airport.getBomberMilitaryPlanes();
        Assert.assertTrue(hasPlanesWithOnlyOneMilitaryType(bomberMilitaryPlanes, MilitaryType.BOMBER));
    }

    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        List<ExperimentalPlane> experimentalPlanes = airport.getExperimentalPlanes();
        Assert.assertTrue(hasPlanesWithClassificationLevelHigherThanUnclassified(experimentalPlanes));
    }
    ...
    private boolean hasCorrectSortByMaxLoadCapacity(List<? extends Plane> planesSortedByMaxLoadCapacity) {
    ...
    private boolean hasPlanesWithClassificationLevelHigherThanUnclassified(List<ExperimentalPlane> experimentalPlanes) {
