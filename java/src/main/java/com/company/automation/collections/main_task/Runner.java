...
public class Runner {
    public static void main(String[] args) {
        ...
        MotorcycleGear boots = new Boots("Alpinestars", "SMX Plus", BootsType.SPORT, "leather", "black/white", 3.8, 204.55);

        RiderFullEquipment riderFullEquipment = new RiderFullEquipment(helmet, jacket, pants, boots);
        riderFullEquipment.addGear(gloves);
